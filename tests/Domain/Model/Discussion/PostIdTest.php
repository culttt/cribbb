...
class PostIdest extends \PHPUnit_Framework_TestCase
{
    /** @test */
    ...
    /** @test */
    public function should_create_new_post_id()
    {
    ...
    /** @test */
    public function should_generate_new_post_id()
    {
        $id = PostId::generate();
    ...
    /** @test */
    public function should_return_post_id_as_string()
    {
        $id = PostId::fromString('d16f9fe7-e947-460e-99f6-2d64d65f46bc');
